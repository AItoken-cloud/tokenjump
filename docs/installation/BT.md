...
> 📖 官方文档：[宝塔面板部署](https://doc.tokenjump.cc/zh/docs/installation/deployment-methods/bt-docker-installation)
...
- [官方文档](https://doc.tokenjump.cc/zh/docs/installation)
- [环境变量配置](https://doc.tokenjump.cc/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://doc.tokenjump.cc/zh/docs/support/faq)

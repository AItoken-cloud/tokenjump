...
📖 更多部署方式請參考 [部署指南](https://doc.tokenjump.cc/zh/docs/installation)
...
### 📖 [官方文件](https://doc.tokenjump.cc/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/new-api)
...
| 分類 | 連結 |
|------|------|
| 🚀 部署指南 | [安裝文件](https://doc.tokenjump.cc/zh/docs/installation) |
| ⚙️ 環境配置 | [環境變數](https://doc.tokenjump.cc/zh/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文件 | [API 文件](https://doc.tokenjump.cc/zh/docs/api) |
| ❓ 常見問題 | [FAQ](https://doc.tokenjump.cc/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://doc.tokenjump.cc/zh/docs/support/community-interaction) |

---

## ✨ 主要特性

> 詳細特性請參考 [特性說明](https://doc.tokenjump.cc/zh/docs/guide/wiki/basic-concepts/features-introduction)
...
> 詳情請參考 [接口文件 - 閘道接口](https://doc.tokenjump.cc/zh/docs/api)

| 模型類型 | 說明 | 文件 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文件](https://doc.tokenjump.cc/zh/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文件](https://doc.tokenjump.cc/zh/docs/api/ai-model/chat/openai/createresponse) |
...
| 🔄 Rerank | Cohere、Jina | [文件](https://doc.tokenjump.cc/zh/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文件](https://doc.tokenjump.cc/zh/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文件](https://doc.tokenjump.cc/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [響應接口 (Responses)](https://doc.tokenjump.cc/zh/docs/api/ai-model/chat/openai/createresponse)
- [圖像接口 (Image)](https://doc.tokenjump.cc/zh/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音訊接口 (Audio)](https://doc.tokenjump.cc/zh/docs/api/ai-model/audio/openai/create-transcription)
- [影片接口 (Video)](https://doc.tokenjump.cc/zh/docs/api/ai-model/audio/openai/createspeech)
...
- [即時對話 (Realtime)](https://doc.tokenjump.cc/zh/docs/api/ai-model/realtime/createrealtimesession)
...
📖 **完整配置：** [環境變數文件](https://doc.tokenjump.cc/zh/docs/installation/config-maintenance/environment-variables)
...
| 📘 常見問題 | [FAQ](https://doc.tokenjump.cc/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://doc.tokenjump.cc/zh/docs/support/community-interaction) |
| 🐛 回饋問題 | [問題回饋](https://doc.tokenjump.cc/zh/docs/support/feedback-issues) |
| 📚 完整文件 | [官方文件](https://doc.tokenjump.cc/zh/docs) |
...
**[官方文件](https://doc.tokenjump.cc/zh/docs)** • **[問題回饋](https://github.com/Calcium-Ion/new-api/issues)** • **[最新發布](https://github.com/Calcium-Ion/new-api/releases)**

...
type ChannelMeta struct {
	...
	ChannelOnlyBaseUrl     bool
	ChannelCustomAdaptorId int
	ApiType                int
	ApiVersion             string
	ApiKey                 string
	Organization           string
...
func (info *RelayInfo) InitChannelMeta(c *gin.Context) {
	...
	channelMeta := &ChannelMeta{
		...
		ChannelOnlyBaseUrl:     common.GetContextKeyBool(c, constant.ContextKeyChannelOnlyBaseUrl),
		ChannelCustomAdaptorId: common.GetContextKeyInt(c, constant.ContextKeyChannelCustomAdaptorId),
		ApiType:                apiType,
